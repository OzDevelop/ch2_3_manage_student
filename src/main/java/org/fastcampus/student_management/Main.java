...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CourseJdbcCommandRepository courseJdbcRepository = new CourseJdbcCommandRepository();

    StudentService studentService = new StudentService(studentRepository);
    CourseService courseService = new CourseService(courseRepository, courseJdbcRepository, studentRepository);
    ...
    StudentInfoDto studentInfoDto1 = new StudentInfoDto("존도", 23, "서울시 노원구");
